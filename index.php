                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                ...
                                <p>Enjoy a memorable and comfortable Journey </p>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                ...
                                <p>Which can never be forgotten</p>
                                <!-- <a href="#" class="boxed-btn3">Explore Now</a> -->
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        ...
                        <p>We provide our services in following Cities</p>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        <h3>Our Fleet</h3>
                        <p>We have a long range of Luxury Cars/Bus</p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="more_place_btn text-center">
                        <a class="boxed-btn4" href="fleet.html">More Details</a>
                    </div>
                </div>
            </div>
        </div>
